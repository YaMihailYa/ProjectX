...
enum menu_type_t { START, PAUSE, LEVEL_END, LEVEL_SELECTION };
enum btn_type_t { BTN_START, BTN_OPTIONS, BTN_QUIT, BTN_NEXT_LEVEL, BTN_LEVEL_SELECTION, BTN_HOME, BTN_LEV_1, BTN_LEV_2, BTN_LEV_3 };
